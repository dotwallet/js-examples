...
app.get('/wishlist-front', async (req, res) => {
  res.sendFile(path.join(__dirname + '/wishlist-front.html'));
});
...
app.get('/autopayment-wishlist', async (req, res) => {
  res.sendFile(path.join(__dirname + '/autopayment-wishlist.html'));
});
...
const savedDataTxns = []; // In real app could wishlist in DB. Save a list of txns to retrieve data
